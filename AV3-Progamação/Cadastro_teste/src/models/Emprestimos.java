 ...
 * @author 12825135945
 */
public class Emprestimos extends ID {
    ...
    public Emprestimos(int id, String ID_livro, String ID_membro, LocalDate data_emprestimo, LocalDate data_devolucao, String status) {
        super(id);
