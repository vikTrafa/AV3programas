...
public class InterfaceRegistrarEmprestimo extends JFrame {
    ...
    public InterfaceRegistrarEmprestimo() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(InterfaceRegistrarEmprestimo::new);
    }
}
