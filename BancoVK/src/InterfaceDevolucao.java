...
public class InterfaceDevolucao extends JFrame {
    ...
    public InterfaceDevolucao() {
        ...
        JPanel formPanel = new JPanel(new GridLayout(4, 2, 10, 10)); // aumentei linhas para o botão voltar
        ...
        formPanel.add(voltarButton);  // botão adicionado aqui
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new InterfaceDevolucao());
    }
}
